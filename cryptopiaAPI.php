...
class Cryptopia extends Exchange{
   ...
   public function __construct() {
      $this->privateKey = 'p8MSTGPbv9LIbXB+/7ihyZlKouk5+L/6yTQxPmW+8wA=';
      $this->publicKey = '7de980f6e3914ed9aa5b2c687b07e2f4';
   ...
   public function setSymbols() {
	 ...
	 public function GetCurrencies() {
      $result = json_decode($this->apiCall("GetCurrencies", array() ), true);

      return $result;
    }
    
	public function getTicker($pair) {
		$result = json_decode($this->apiCall("GetMarket", array($pair) ), true);
		return $result;
	}
