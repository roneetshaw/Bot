...
class yobit_api
{
    ...
    {
        $this->tradingUrl = 'https://yobit.net/tapi/';
        $this->publicUrlV2 = 'https://yobit.net/api/2/';
        $this->publicUrlV3 = 'https://yobit.net/api/3/';

        $this->key = '249AA10DF990E202527CBFDBAE0280FE';
        $this->secret = '4a795178c662868231747e63c97a61f8';
    }
    ...
    {
        return $this->YoInfo('v3', "ticker/$currencyPair");
    }
    ...
    public function getTickers(array $currencyPairs = [], $ignoreInvalid = false)
    {
        ...
        return $this->YoInfo('v3', $urlFragment, [
    ...
    {
        return $this->YoInfo('v3', "depth/$currencyPair", [
            'limit' => $limit,
        ]);
    }
    ...
    {
        $impl = implode('-', $currencyPairs);
        return $this->YoInfo('v3', "depth/$impl", [
            'ignore_invalid' => (int) $ignoreInvalid,
            'limit' => $limit,
        ]);
    }
    ...
    {
        return $this->YoInfo('v3', "trade/$currencyPair", [
            'limit' => $limit,
        ]);
    }
    ...
    {
        $impl = implode('-', $currencyPairs);
        return $this->YoInfo('v3', "trade/$impl", [
            'ignore_invalid' => (int) $ignoreInvalid,
            'limit' => $limit,
        ]);
    }
    ...
    private function YoInfo ($version, $segments, array $parameters=[])
    {
        $options = [
            'http' => [
                'method'  => 'GET',
    ...
    private function tradeRequest($method, array $parameters = [], $isRetry=false)
    {
        ...
        if (!$response) throw new Exception('Invalid data received, please make sure connection is working and requested API exists: '.$response);
